                ...
                <div className="font-mono flex flex-col xl:flex-row items-center justify-center gap-10 xl:gap-16 w-full">
                    ...
                    <div className="flex flex-col justify-around items-center gap-6 md:gap-8 w-full xl:w-auto px-4 md:px-0">
                        ...
                        <div className="p-2 pt-2 md:pt-4 flex flex-wrap justify-center gap-3 md:gap-5 w-full">
                            <span className="border border-zinc-200 dark:border-zinc-800 p-2 px-4 bg-zinc-100 dark:bg-zinc-900/60 hover:bg-zinc-200 dark:hover:bg-zinc-800/80 transition-colors text-amber-600 dark:text-yellow-450 md:text-zinc-700 md:dark:text-zinc-300 rounded-sm font-bold md:font-normal text-sm md:text-base">
                                NIAT
                            </span>
                            <span className="border border-zinc-200 dark:border-zinc-800 p-2 px-4 bg-zinc-100 dark:bg-zinc-900/60 hover:bg-zinc-200 dark:hover:bg-zinc-800/80 transition-colors text-amber-600 dark:text-yellow-450 md:text-zinc-700 md:dark:text-zinc-300 rounded-sm font-bold md:font-normal text-sm md:text-base">
                                HYDERABAD
